...
public class HighestMovieAdapter extends RecyclerView.Adapter<MoviePageListAdapter.ViewHolder> {

    private Context context;
    private List<Movie> movies;


    public HighestMovieAdapter(Context context, List<Movie> movies){
